 ...
 *
 * The followings are the available columns in table 'seting':
 * @property integer $id
 * @property integer $defaultstatusComment
 * @property integer $defaultstatusUser
 */
class Seting extends CActiveRecord
{
	/**
	...
	public function attributeLabels()
	{
		return array(
			'id' => 'ID',
			'defaultstatusComment' => 'Default confirm comments',
			'defaultstatusUser' => 'Default ban user',
		);
	}
	 ...
	 * @return Seting the static model class
	 */
